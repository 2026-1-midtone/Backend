...
class ChatServiceTest {
    ...
    void 제품_추천_요청은_추천_전용_근거로_AI를_호출한다() {
        ...
        ChatContextSnapshot snapshot = new ChatContextSnapshot(today, null, null, java.util.List.of(), null,
                java.util.List.of(), null, java.util.List.of(), new ChatContextSnapshot.RoutineProgress(0, 0),

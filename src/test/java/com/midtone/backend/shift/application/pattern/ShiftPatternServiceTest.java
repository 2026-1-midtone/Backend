...
class ShiftPatternServiceTest {
    ...
    void 존재하지_않는_패턴을_삭제하면_예외를_던진다() {
        ...
        ShiftException exception =
                assertThrows(ShiftException.class, () -> shiftPatternService.deleteShiftPattern(999L));
        assertEquals(ShiftException.ErrorCode.SHIFT_PATTERN_NOT_FOUND, exception.getErrorCode());
    }
}

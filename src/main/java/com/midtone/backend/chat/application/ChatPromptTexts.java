...
final class ChatPromptTexts {
    ...
    static final String SYSTEM_PROMPT = """
            ...
            - productUrl은 앱이 구매 링크 버튼으로 직접 보여준다. 답변 문장 안에 URL을 적지 마라.
    ...
    private ChatPromptTexts() {
    }

    static String renderInput(ChatPrompt prompt) {
        return "question:\n" + prompt.question()
                + "\n\ncontext_snapshot:\n" + OBJECT_MAPPER.writeValueAsString(prompt.contextSnapshot())

...
public record CreateCaffeineIntakeRequest(
        @NotNull(message = "consumedAt은 필수 입력값입니다.") OffsetDateTime consumedAt,
        @Positive(message = "amountMg는 1 이상이어야 합니다.") int amountMg,
